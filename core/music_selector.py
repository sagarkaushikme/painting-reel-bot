"""
Music Selector — picks background music based on mood and intensity.

Looks for MP3 files in mood-specific folders under music/.
"""
...
def select_music(mood: str, intensity: str):
    """
    Select a music track based on mood and intensity.
