"""
Instagram Uploader — Upload reels via Graph API + host video on GitHub Releases.
...
def host_video_on_github(
    ...
    release_name = f"Painting Reel — {datetime.now().strftime('%Y-%m-%d')}"
    ...
    release_data = {
        "tag_name": tag,
        "name": release_name,
        "body": "Auto-generated painting reel",
        "draft": False,
        "prerelease": False,
    }
